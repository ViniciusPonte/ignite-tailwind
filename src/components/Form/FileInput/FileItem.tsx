...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      complete: {
        container: 'bg-violet-500 dark:bg-violet-300/30',
      },
      error: {
        container:
          'bg-error-25 border-error-300 dark:bg-error-500/5 dark:border-error-500/30',
        icon: 'border-error-50 bg-error-100 text-error-600 dark:bg-error-500/5 dark:bg-error-500/30 dark:text-error-400',
        deleteButton:
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="fonte-medium text-error-700  dark:text-error-400 text-sm">
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="fonte-medium text-sm text-zinc-700 dark:text-zinc-100">
              {name}
            </span>
